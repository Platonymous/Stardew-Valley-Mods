...
But you should also ask {CPTEXT("npc")}, I know {GetPronoun(CPTEXT("npc"))} has a gift for Haley. {setseen()} # BREAK # ADD {CPTEXT("npc")} THIS 
-> alex
...
{choice == alexgift:
    ...
    - else:
    <>$h that sound {ChangeFS("good",10)}, and 
}
- ->->
