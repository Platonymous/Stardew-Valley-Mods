...
namespace TMXLoader
{
    public class UIHelper
    {
        ...
        public static Texture2D DarkTheme
        {
            ...
            {
                if (_dark == null)
                    _dark = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(473,36,24,24));
        ...
        public static Texture2D TabTheme
        {
            ...
            {
                if (_tab == null)
                    _tab = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(16, 368, 16, 16));
        ...
        public static Texture2D YellowTheme
        {
            ...
            {
                if (_yellow == null)
                    _yellow = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/DialogBoxGreen").getArea(new Rectangle(16, 16, 160, 160));
        ...
        public static Texture2D YellowbBoxTheme
        {
            ...
            {
                if (_yellowBox == null)
                    _yellowBox = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(293, 360, 24, 24));
        ...
        public static Texture2D YellowCombBoxesLeftTheme
        {
            get
            {
                if (_yellowComb1 == null)
                    _yellowComb1 = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(293, 360, 18, 24));
        ...
        public static Texture2D YellowCombBoxesRightTheme
        {
            get
            {
                if (_yellowComb2 == null)
                    _yellowComb2 = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(311, 360, 18, 24));
        ...
        public static Texture2D BounceClose
        {
            get
            {
                if (_bounceClose == null)
                    _bounceClose = new AnimatedTexture2D(TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(289, 342, 121, 12)),11,12,12,true,true,1);
        ...
        public static Texture2D WhiteBubbly
        {
            get
            {
                if (_whitebubble == null)
                    _whitebubble = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(111, 1870, 54, 49));
        ...
        public static Texture2D Houreglas
        {
            ...
            {
                if (_hourglas == null)
                    _hourglas = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(16, 0, 10, 16));
        ...
        public static Texture2D ArrowUp
        {
            ...
            {
                if (_arrowUp == null)
                    _arrowUp = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(76, 72, 40, 44));
        ...
        public static Texture2D ArrowDown
        {
            ...
            {
                if (_arrowDown == null)
                    _arrowDown = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(12, 76, 40, 44));
        ...
        public static Texture2D ArrowRight
        {
            ...
            {
                if (_arrowRight == null)
                    _arrowRight = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(12, 204, 44, 40));
        ...
        public static Texture2D ArrowLeft
        {
            ...
            {
                if (_arrowLeft == null)
                    _arrowLeft = TMXLoaderMod.helper.GameContent.Load<Texture2D>("LooseSprites/Cursors").getArea(new Rectangle(8, 268, 44, 40));
